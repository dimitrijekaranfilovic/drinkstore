...
func main() {
	...
	//samo ostali servisi
	router.HandleFunc("/api/users/authorize-admin", requestHandler.AuthorizeAdmin).Methods("GET", "POST", "PUT", "PATCH")
	//samo ostali servisi
	router.HandleFunc("/api/users/authorize-user", requestHandler.AuthorizeUser).Methods("GET", "POST", "PUT", "PATCH")
	//samo ostali servisi
